...
export default function Welcome({
  ...
  return (
      <>
          <Head title="Welcome to Spice Weather"/>
                      ...
                      <div className="relative flex items-center justify-center py-5 lg:justify-between">
                          ...
                          <div className="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
                              ...
                              <Menu as="div" className="relative ml-4 shrink-0">
                                  <div>
                                      <MenuButton
                                          className="relative flex rounded-full bg-white text-sm ring-2 ring-white/20 focus:outline-none focus:ring-white">
                                          <span className="absolute -inset-1.5"/>
                          ...
                          <div className="absolute right-0 shrink-0 lg:hidden">
                              {/* Mobile menu button */}
                              <PopoverButton
                                  className="group relative inline-flex items-center justify-center rounded-md bg-transparent p-2 text-indigo-200 hover:bg-white/10 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
